...
opt = {
   ...
   learningRate =5e-4,    -- 5E-3 FOR sgd
   momentum = 0.95,   -- 0.95
...
hyperPath = '/home/mark/Documents/VT_learning/coordinates/'
...
-- which coordinate axis you want to train with
axis=3
qrsData.train_coord = qrsData.train_coord[{{},{axis}}]
qrsData.val_coord = qrsData.val_coord[{{},{axis}}]
qrsData.test_coord = qrsData.test_coord[{{},{axis}}]
...
local mser_test_mean,mser_test_std,mser_test_ci95,mser_test_xyz = MSERloss(outputs_test,qrsData.test_coord)
...
print('The stat on each axis, x: '..tostring(mser_test_xyz.x))
