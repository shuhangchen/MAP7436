...
hopt = {              
   ...
   numHiddenUnits = {500},  -- { 2, 3, 3, 2},     --probabilities for selecting those values 800, 1000, 1200, 1500
   --  warpped  
   marginMain =torch.Tensor({6, 7, 8}),
   hingeCoef ={ 0.8,1.2,1.6,2},
...
for i = 1, #hopt.numHiddenUnits do
   for j=3, hopt.marginMain:size(1) do
      for k=1, #hopt.hingeCoef do
	 for nt=1,1 do --#hopt.noiseType do  -- only gaussian noise
