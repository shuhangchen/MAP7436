...
hexperName = '/home/mark/Documents/VT_learning/secondLayer'
...
-- load the QRS data
qrsData_loaded = torch.load('/home/mark/Documents/VT_learning/secondLayer/qrsLayer2.t7')

-- load the QRS pair data
qrsPairs_loaded = torch.load('/home/mark/Documents/VT_learning/data/qrsPairs1012.t7')
if opt.cuda then
