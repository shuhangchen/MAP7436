...
function factornnMSE.train(opt,j,k,nt,nc)
   ...
   hexperName = '/home/mark/Documents/VT_learning/Logs/logPAsquare/MES_j'..tostring(j)..'k'..tostring(k)..'nt'..tostring(nt)..'nc'..tostring(nc)
--   hexperName = '/media/usb/log/MES/MES_'..'j'..tostring(j)..'k'..tostring(k)..'nt'..tostring(nt)..'nc'..tostring(nc)
   ...
   qrsPairs = torch.load('/home/mark/Documents/VT_learning/data/qrsPairs_coord.t7')
   if opt.cuda then
