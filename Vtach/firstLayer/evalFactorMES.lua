...
function evalFactorMES.eval(j,k,nt,nc)
...
--   j,k,nt,nc=1,1,1,1
   ...
   --plot them
   if opt.evalVT then
      gnuplot.epsfigure(hyperExperName.."/VTnodes/factorLoss.eps")
   else
   ...
   if opt.evalVT then
      gnuplot.epsfigure(hyperExperName.."/VTnodes/classfy.eps")
   else
   ...
   if opt.evalVT then
      gnuplot.epsfigure(hyperExperName.."/VTnodes/distances.eps")
   else
