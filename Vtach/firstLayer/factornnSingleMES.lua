...
hexperName = '/home/mark/Documents/VT_learning/save'


torch.save(hexperName..'/hypersTuned.t7',opt)
...
-- load the QRS data
qrsData = torch.load('data/qrsDataNormalized.t7')

-- load the QRS pair data
qrsPairs = torch.load('/home/mark/Documents/VT_learning/data/qrsPairs.t7')
if opt.cuda then
...
torch.save(hexperName..'/factorMESTuned.net', factor)
torch.save(hexperName..'/factor_lossFunMESTuned.t7', lossFunTrack)
